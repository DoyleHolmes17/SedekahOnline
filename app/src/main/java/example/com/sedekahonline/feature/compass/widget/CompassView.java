...
public class CompassView extends View implements SensorEventListener {
    ...
    public CompassView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int colorAccent = ContextCompat.getColor(getContext(), R.color.light_green);
        ...
        mSecondaryColor = a.getColor(R.styleable.CompassView_secondaryColor, getResources().getColor(R.color.dc_lightgray));
